...
if __name__ == '__main__':
    _outdir = 'D:/traindata/TEXTVOC/VOC2007'
    _draw = bool(0)
    _dest_label_dir, _dest_img_dir, _dest_set_dir = build_voc_dirs(_outdir)
    _doncateothers = bool(1)
    for dset in ['train']:
        _labeldir = 'C:/programing/faster-CTPN-master/data/traindata/label_temp'
        _imagedir = 'C:/programing/faster-CTPN-master/data/traindata/re_img'
