...
class SolverWrapper(object):
    ...
    def build_image_summary(self):
        ...
        log_image = tf.summary.image(str(log_image_name), tf.expand_dims(log_image_data, 0), max_outputs=10)
    ...
    def train_model(self, sess, max_iters, restore=False):
        ...
        #input_img,conv1_2_img,conv2_2_img,conv3_3_img,conv4_3_img,conv5_3_img,rpn_conv_img = self.net.build_output_imgage(ohem=cfg.TRAIN.OHEM)
        ...
        # image summary
        #tf.summary.image('input_img',input_img,max_outputs=2)
        #tf.summary.image('conv1_1_img',conv1_1_img,max_outputs=3)
        #tf.summary.image('conv1_2_img',conv1_2_img,max_outputs=2)
        #tf.summary.image('conv2_2_img',conv2_2_img,max_outputs=3)
        #tf.summary.image('conv3_3_img',conv3_3_img,max_outputs=2)
        #tf.summary.image('conv4_3_img',conv4_3_img,max_outputs=3)
        #tf.summary.image('conv5_3_img',conv5_3_img,max_outputs=2)
        #tf.summary.image('rpn_conv_img',rpn_conv_img,max_outputs=3)
        #tf.summary.image('reshape_1_img',rpn_conv_img,max_outputs=3)
        #tf.summary.image('reshape_2_img',rpn_conv_img,max_outputs=3)
        #tf.summary.image('reshape_3_img',rpn_conv_img,max_outputs=3)
        #tf.summary.image('rpn_cls_score_img',rpn_cls_score_img,max_outputs=10)
        #tf.summary.image('rpn_bbox_pred_img',rpn_bbox_pred_img,max_outputs=10)
